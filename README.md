...
- My organization: 
<a href="https://github.com/uoi-coding-lab" target="_blank" style="display: inline-block;">
  <img src="./uoi-coding-lab.png" 
       alt="uoi-coding-lab" 
       style="width: 100px; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); transition: transform 0.2s ease-in-out;" 
